...
export default function AddChannel() {
  ...
  const handleAddChannelSubmit = async (e) => {
    ...
    requestHandler({
      api: async () => await api.createGroupChat({ ...formData, participants: participants }),
      ...
      <Modal>
        <div className="z-30 grid h-[60vh] w-screen place-items-center bg-transparent">
          <div
            ...
            <form onSubmit={handleAddChannelSubmit} className="w-full">
              <ChannelForm type={"Add"} data={formData} setData={setFormData} />
